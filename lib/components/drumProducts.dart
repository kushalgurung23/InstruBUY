...
class DrumProducts extends StatefulWidget {
  @override
  _DrumProductsState createState() => _DrumProductsState();
}

class _DrumProductsState extends State<DrumProducts> {
  @override
      ...
      builder: (BuildContext context, Widget child, ParentModel parentModel) {
        return Padding(
          ...
          child: GridView.count(
              ...
              children: [
                ...List.generate(
                  parentModel.drumValue.length,
                      (index) => AllProducts(
                    product: parentModel.drumProducts[index],
