...
class UkuleleProducts extends StatefulWidget {
  @override
  _UkuleleProductsState createState() => _UkuleleProductsState();
}

class _UkuleleProductsState extends State<UkuleleProducts> {
  @override
      ...
      builder: (BuildContext context, Widget child, ParentModel parentModel) {
        return Padding(
          ...
          child: GridView.count(
            ...
            children: [
              ...List.generate(
                parentModel.ukuleleValue.length,
                (index) => AllProducts(
                  product: parentModel.ukuleleProducts[index],
